...
sql = "NOT DataSource = 'GLO' AND NR_Status IN ( 'eligible', 'eligible and part of a district', 'listed', 'listed individually and in historic district', 'eligible/not eligible', 'eligible/unevaluated')"
...
write_csv(output_folder, 'S-2_Proposed_Route', fields, proposed_route_list)
...
# Write results to a .CSV
fields = ['Site #', 'Site Class', 'Site Type', 'Route', 'County', 'NRHP Status']
write_csv(output_folder, 'S-2_Alternative_Route', fields, alternative_route_list)
...
management.MakeFeatureLayer(monitoring_poly, "MP", "NOT DataSource = 'SHPO (Oregon)' AND NR_Status IN ( 'eligible', 'eligible and part of a district', 'listed', 'listed individually and in historic district', 'eligible/not eligible', 'eligible/unevaluated')")
...
write_csv(output_folder, 'S-2_Proposed_Route_Class_I_Updates', fields, proposed_route_list)
...
fields = ['Site #', 'Site Class', 'Route', 'County', 'NRHP Status']		
write_csv(output_folder, 'S-2_Alternative_Route_Class_I_Updates', fields, alternative_route_list)
