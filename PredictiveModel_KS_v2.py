...
dist_to_water_range = sa.RemapRange([[0, 50, 0], [50, 250, 3], [250, 500, 2], [500, 100000, 0]])
...
veg_values = sa.RemapValue([ [17,0], [12,0], [16,0], [8,0], [11,0], [9,0], [1,3], [2,3], [3,3], [4,3], [5,3], [6,3], [7,3], [10,3], [13,3], [14,3], [15,3], [18,3] ])
...
mapAlgebra.save(r'C:\Users\Mitchell.Fyock\Desktop\Projects\KS_Flat_Ridge_Wind_Farm\GIS\Data\TetraTech\Ks_Flat_Ridge_Wind_Farm_Master.gdb\Predictive_Model_v4')
