...
management.MakeFeatureLayer(land_status, "Land_Status", "FEDERAL_STATUS = 'PD'")
...
write_csv(output_folder, 'S-6_Proposed_Route', fields, proposed_route_list)
...
write_csv(output_folder, 'S-6_Alternative_Route', fields, alternative_route_list)
...
# Write results to a .CSV
fields = ['County', 'Pre-Contact', 'Historic', 'Multi-Component', 'Unknown', 'Total']	
write_csv(output_folder, 'S-6_Proposed_Route_Class_I_Updates', fields, proposed_route_list)
...
fields = ['Route', 'Pre-Contact', 'Historic', 'Multi-Component', 'Unknown', 'Total']
write_csv(output_folder, 'S-6_Alternative_Route_Class_I_Updates', fields, alternative_route_list)
