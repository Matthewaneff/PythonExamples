...
01/17/2017		MF			Added 'write_csv' function
========================================================================
...
#~ output_folder = r'P:\Boardman to Hemingway Transmission Project\B to H Docs\Cultural Resources\B2H_GIS\Data\TetraTech\Application_for_Site_Certification\Exhibit_S_Cultural_Resources\Table_S-5'
...
# Land Status
land_status = r'P:\Boardman to Hemingway Transmission Project\B to H Docs\Cultural Resources\B2H_GIS\Data\TetraTech\LandStatus\20161108_B2HLandStatus\land_lines.gdb\land_lines\OWNERSHIP_POLY'
management.MakeFeatureLayer(land_status, "Land_Status", "PROPERTY_STATUS IN ( 'PV', 'PVI', 'PVN', 'PVU')")
...
for county in counties_list:
	...
	for feature in feature_list:
		...
		management.SelectLayerByLocation(feature, "INTERSECT", 'Land_Status', '', 'SUBSET_SELECTION')
...
write_csv(output_folder, 'S-5_Proposed_Route', fields, proposed_route_list)
...
write_csv(output_folder, 'S-5_Alternative_Route', fields, alternative_route_list)
...
for county in counties_list:
	...
	management.SelectLayerByLocation("MP", "INTERSECT", 'Land_Status', '', 'SUBSET_SELECTION')
...
# Write results to a .CSV
fields = ['County', 'Pre-Contact', 'Historic', 'Multi-Component', 'Unknown', 'Total']	
write_csv(output_folder, 'S-5_Proposed_Route_Class_I_Updates', fields, proposed_route_list)
...
fields = ['Route', 'Pre-Contact', 'Historic', 'Multi-Component', 'Unknown', 'Total']
write_csv(output_folder, 'S-5_Alternative_Route_Class_I_Updates', fields, alternative_route_list)
